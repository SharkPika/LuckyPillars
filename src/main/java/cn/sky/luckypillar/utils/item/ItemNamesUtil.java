...
public class ItemNamesUtil {
	public static String getRealName(Material material) {
		return getRealName(material.getId());
	}

	public static String getRealName(ItemStack itemStack) {
		return getRealName(itemStack.getType().getId());
	}
